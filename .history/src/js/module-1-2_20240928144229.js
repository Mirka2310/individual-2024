...
console.log("Для значення 27.3:");
console.log("Math.floor():", Math.floor(value1));  // Округлення вниз: 27
console.log("Math.ceil():", Math.ceil(value1));    // Округлення вгору: 28
console.log("Math.round():", Math.round(value1));  // Округлення за правилами: 27

console.log("Для значення 27.9:");
console.log("Math.floor():", Math.floor(value2));  // Округлення вниз: 27
console.log("Math.ceil():", Math.ceil(value2));    // Округлення вгору: 28
console.log("Math.round():", Math.round(value2));  // Округлення за правилами: 28
