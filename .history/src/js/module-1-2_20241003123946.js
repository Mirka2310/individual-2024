...
const value = 27.5;
console.log(Math.floor(value)); //  (заокруглення вниз)  27
console.log(Math.ceil(value));  // (заокруглення вгору)  28
console.log(Math.round(value)); //  (до найближчого цілого) 28
...
const value = incomingValue _ defaultValue;
console.log(value);