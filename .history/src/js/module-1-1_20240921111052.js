...
const combinationLetters = lastLetterStr1 + lastLetterStr2;


console.log(combinationLetters);
...
const len = userValue.toString().length;

const newUserValue = userValue * (5**len);
